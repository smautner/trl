...
def update_version_py():
    ...
    try:
        ...
        print("unable to run git, leaving trullo/__version__.py alone")
        return
    ...
    f = open("trullo/__version__.py", "w")
    f.write(VERSION_PY % ver)
    f.close()
    print("set trullo/__version__.py to '%s'" % ver)


def get_version():
    try:
        f = open("trullo/__version__.py")
    except EnvironmentError:
        return None
...
setup(
    ...
    package_data={},
    url='',
    entry_points = { 'console_scripts': ['trl=trullo.trololo:main'] },
    license='GPLv3',
    description='trello cli',
    #long_description=open('README.md').read(),
    install_requires=['requests','attrs','docopt'],
